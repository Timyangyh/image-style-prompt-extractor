...
This application stores model configuration, API keys, analysis history, generation tasks, and edit tasks in the local Electron user data directory on each device. These files are runtime data and should not be committed to the repository.
