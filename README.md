...
![图片复刻大师提示词解析完成界面](assets/ui-prompt-analysis.png)
...
- 升级 Liquid Pro 界面、浅深主题和可调工作区布局。
- 完善全屏交互及 macOS / Windows 跨平台回归。
- 更新开发期传递依赖，修复已知高危审计项。

### v1.1.7

- 新增支持批量解析图片、生成图片和修改图片。
- 图片解析完成后，无需上传任何修改图，可直接使用原始解析提示词进行文生图，并支持继续修改参考图中的文字。
